...
export const CATEGORIES = [
  { id: 'all', label: 'All Domains (62)', icon: '🏛️' },
...
export const DEMO_SOCIETIES = [
  ...
  // --- 13. Dhwani (Music Society) ---
  {
    ...
    scheduledForm: {
      ...
      initialDeadline: '2026-08-30T17:00:00+05:30',
      extendedDeadline: '2026-08-30T23:59:59+05:30',
    ...
    get deadline() {
      if (this.scheduledForm && new Date() >= new Date(this.scheduledForm.liveFrom)) {
        return this.scheduledForm.extendedDeadline || this.scheduledForm.deadline;
      }
      return null;
    },
    get statusText() {
  ...
  // --- 29b. Connecting Dreams Foundation (CDF) ---
  {
    ...
    scheduledForm: {
      ...
      initialDeadline: '2026-08-30T15:00:00+05:30',
      extensionTrigger: '2026-08-30T14:55:00+05:30',
      extendedDeadline: '2026-08-30T21:00:00+05:30',
    },
    get recruitmentFormUrl() {
      if (this.scheduledForm && new Date() >= new Date(this.scheduledForm.liveFrom)) {
        return this.scheduledForm.recruitmentFormUrl;
  ...
  // --- 33. CBS Post ---
  {
    ...
    scheduledForm: {
      ...
      initialDeadline: '2026-08-30T17:00:00+05:30',
      extensionTrigger: '2026-08-30T16:55:00+05:30',
      extendedDeadline: '2026-08-30T23:59:59+05:30',
    },
    get recruitmentFormUrl() {
      if (this.scheduledForm && new Date() >= new Date(this.scheduledForm.liveFrom)) {
